...
void opcontrol() {
	...
	while(true) {
		...
		motor5.move(joystick_value - joystick_valueX);
		motor6.move(joystick_value - joystick_valueX);
		motor7.move(joystick_value - joystick_valueX);
		motor8.move(joystick_value - joystick_valueX);
