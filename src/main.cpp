...
void autonomous() {
	...
	okapi::Motor middle_rt(7, false, okapi::AbstractMotor::gearset::green, okapi::AbstractMotor::encoderUnits::rotations);
	...
	okapi::Motor middle_lft(19, true, okapi::AbstractMotor::gearset::green, okapi::AbstractMotor::encoderUnits::rotations);
...
void opcontrol() {
	...
	while (true){
        ...
        // Tank Drive Mechanics
        /* if(master.get_analog(ANALOG_LEFT_Y) > 0 && master.get_analog(ANALOG_RIGHT_Y) > 0) {
            front_rt.moveVelocity(-master.get_analog(ANALOG_RIGHT_Y)*100);
            back_rt.moveVelocity(-master.get_analog(ANALOG_RIGHT_Y)*100);
            front_lft.moveVelocity(-master.get_analog(ANALOG_LEFT_Y)*100);
            back_lft.moveVelocity(-master.get_analog(ANALOG_LEFT_Y)*100);
        } else if(master.get_analog(ANALOG_LEFT_Y) < 0 && master.get_analog(ANALOG_RIGHT_Y) < 0) {
            front_rt.moveVelocity(-master.get_analog(ANALOG_RIGHT_Y)*100);
            back_rt.moveVelocity(-master.get_analog(ANALOG_RIGHT_Y)*100);
            front_lft.moveVelocity(-master.get_analog(ANALOG_LEFT_Y)*100);
            back_lft.moveVelocity(-master.get_analog(ANALOG_LEFT_Y)*100);
            ...
            front_rt.moveVelocity(0);
            back_rt.moveVelocity(0);
            front_lft.moveVelocity(0);
            back_lft.moveVelocity(0);
        } */

        double y_l = master.get_analog(ANALOG_LEFT_Y)*500;
        double y_r = master.get_analog(ANALOG_RIGHT_Y)*500;
        front_rt.moveVelocity(y_r);
        back_rt.moveVelocity(y_r);
        front_lft.moveVelocity(y_l);
        back_lft.moveVelocity(y_l);
